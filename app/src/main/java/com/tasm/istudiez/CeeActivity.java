...
public class CeeActivity extends AppCompatActivity {
	...
	private void initialize() {
		...
		textview55.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Be101_01Activity.class);
				startActivity(home);
			}
		});
		...
		textview65.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce201Activity.class);
				startActivity(home);
			}
		});
		...
		textview64.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce203Activity.class);
				startActivity(home);
			}
		});
		...
		textview63.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce205Activity.class);
				startActivity(home);
			}
		});
		...
		textview62.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce207Activity.class);
				startActivity(home);
			}
		});
		...
		textview71.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce202Activity.class);
				startActivity(home);
			}
		});
		...
		textview70.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce204Activity.class);
				startActivity(home);
			}
		});
		...
		textview68.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce208Activity.class);
				startActivity(home);
			}
		});
		...
		textview78.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce301Activity.class);
				startActivity(home);
			}
		});
		...
		textview76.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce305Activity.class);
				startActivity(home);
			}
		});
		...
		textview75.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce307Activity.class);
				startActivity(home);
			}
		});
		...
		textview74.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce309Activity.class);
				startActivity(home);
			}
		});
		...
		textview112.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce361Activity.class);
				startActivity(home);
			}
		});
		...
		textview111.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce363Activity.class);
				startActivity(home);
			}
		});
		...
		textview110.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce365Activity.class);
				startActivity(home);
			}
		});
		...
		textview120.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce367Activity.class);
				startActivity(home);
			}
		});
		...
		textview73.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce369Activity.class);
				startActivity(home);
			}
		});
		...
		textview109.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce371Activity.class);
				startActivity(home);
			}
		});
		...
		textview121.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce373Activity.class);
				startActivity(home);
			}
		});
		...
		textview84.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce302Activity.class);
				startActivity(home);
			}
		});
		...
		textview83.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), It304Activity.class);
				startActivity(home);
			}
		});
		...
		textview82.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce306Activity.class);
				startActivity(home);
			}
		});
		...
		textview81.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce308Activity.class);
				startActivity(home);
			}
		});
		...
		textview108.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce362Activity.class);
				startActivity(home);
			}
		});
		...
		textview107.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce364Activity.class);
				startActivity(home);
			}
		});
		...
		textview106.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce366Activity.class);
				startActivity(home);
			}
		});
		...
		textview105.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce368Activity.class);
				startActivity(home);
			}
		});
		...
		textview79.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce372Activity.class);
				startActivity(home);
			}
		});
		...
		textview122.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce374Activity.class);
				startActivity(home);
			}
		});
		...
		textview90.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce401Activity.class);
				startActivity(home);
			}
		});
		...
		textview89.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce403Activity.class);
				startActivity(home);
			}
		});
		...
		textview88.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce405Activity.class);
				startActivity(home);
			}
		});
		...
		textview87.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce407Activity.class);
				startActivity(home);
			}
		});
		...
		textview86.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce409Activity.class);
				startActivity(home);
			}
		});
		...
		textview104.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce461Activity.class);
				startActivity(home);
			}
		});
		...
		textview103.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce463Activity.class);
				startActivity(home);
			}
		});
		...
		textview102.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce465Activity.class);
				startActivity(home);
			}
		});
		...
		textview101.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce467Activity.class);
				startActivity(home);
			}
		});
		...
		textview124.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce469Activity.class);
				startActivity(home);
			}
		});
		...
		textview123.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce471Activity.class);
				startActivity(home);
			}
		});
		...
		textview85.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce473Activity.class);
				startActivity(home);
			}
		});
		...
		textview96.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce402Activity.class);
				startActivity(home);
			}
		});
		...
		textview95.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce404Activity.class);
				startActivity(home);
			}
		});
		...
		textview94.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce462Activity.class);
				startActivity(home);
			}
		});
		...
		textview93.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce464Activity.class);
				startActivity(home);
			}
		});
		...
		textview92.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce466Activity.class);
				startActivity(home);
			}
		});
		...
		textview91.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce468Activity.class);
				startActivity(home);
			}
		});
		...
		textview100.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce472Activity.class);
				startActivity(home);
			}
		});
		...
		textview125.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				home.setClass(getApplicationContext(), Ce474Activity.class);
				startActivity(home);
			}
		});
	}
